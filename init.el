...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(markdown-mode use-package smex nlinum monokai-theme json-mode ido-vertical-mode ido-ubiquitous highlight-thing flx-ido company auto-complete adoc-mode))))
(custom-set-faces
